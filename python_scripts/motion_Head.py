...
#motionProxy.walk()   #Blocking Function
motionProxy.gotoAngle("HeadYaw",   35 * motion.TO_RAD, 1.0, motion.INTERPOLATION_SMOOTH);
#motionProxy.gotoAngle("HeadYaw",   5 * motion.TO_RAD, 1.0, motion.INTERPOLATION_SMOOTH);
motionProxy.gotoAngle("HeadPitch",   30 * motion.TO_RAD, 1.0, motion.INTERPOLATION_SMOOTH);
