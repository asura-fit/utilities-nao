...
try:
  broker = ALBroker("pythonBroker","127.0.0.1",9997,IP, PORT)
...
motionProxy.setWalkExtraConfig( 3.5, -3.5, 0.30, 0 )
...
# LHipRoll(degrees), RHipRoll(degrees), HipHeight(meters), TorsoYOrientation(degrees)
motionProxy.setWalkExtraConfig( 3.5, -3.5, 0.22, 5 )

# StepLength, StepHeight, StepSide, MaxTurn, ZmpOffsetX, ZmpOffsetY 
#motionProxy.setWalkConfig( 0.04, 0.02, 0.02, 0.3, 0.015, 0.018 )
motionProxy.setWalkConfig( 0.04, 0.01, 0.06, 0.3, 0.02, 0.018 )
...
motionProxy.addWalkSideways(-0.02 * 20, 20)
